                  ...
                  <div className="flex flex-wrap gap-2">
                    {index === editingRowIndex ? (
                      <>
                        <button
                          onClick={handleSave}
                          className="bg-[#3B82F6] text-white py-1 px-3 rounded flex items-center hover:bg-[#2563EB] transition-colors text-sm"
                        >
            ...
            <div className="mt-4 flex space-x-2">
              {index === editingRowIndex ? (
                <>
                  <button
                    onClick={handleSave}
                    className="bg-[#3B82F6] text-white py-2 px-3 rounded flex-1 hover:bg-[#2563EB] transition-colors flex justify-center items-center"
                  >
