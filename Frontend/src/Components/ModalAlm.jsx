...
const ModalAlm = ({ isOpen, onClose, onSave }) => {
              ...
              <div className="grid gap-3">
                ...
                {rowIndex === rows.length - 1 && (
                  <button
                    ...
                    className="w-full bg-[#3B82F6] text-white px-3 py-2 rounded hover:bg-[#2563EB] text-sm"
                  >
  ...
  {rows.length > 1 && rowIndex !== rows.length - 1 ? (
    ...
    <button 
      onClick={handleAddRow} 
      className="bg-[#3B82F6] text-white px-3 py-1 rounded hover:bg-[#2563EB] text-sm lg:text-base" 
      disabled={loading}
    >
      <i className="fas fa-plus mr-1"></i> Agregar
        ...
        <div className="flex justify-end space-x-4 mt-4">
          ...
          <button
            onClick={handleSave}
            className="bg-[#3B82F6] text-white px-3 py-2 text-sm sm:px-4 rounded hover:bg-[#2563EB]"
            disabled={loading}
          >
